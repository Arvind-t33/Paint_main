paint.out: delete.o resize.o check_resize.o add.o check_add.o write.o check_write.o print_statements.o quit.o get_command.o input_val.o setup_canvas.o main.o
	gcc delete.o resize.o check_resize.o add.o check_add.o write.o check_write.o print_statements.o quit.o get_command.o input_val.o setup_canvas.o  main.o -o paint.out
...
get_command.o: get_command.c delete.h resize.h add.h write.h check_resize.h check_add.h check_write.h get_command.h quit.h main.h
...
check_resize.o: check_resize.c check_resize.h
	gcc -Wall -Werror -Wextra -c check_resize.c
